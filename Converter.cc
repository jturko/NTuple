...
//            ///////////////////////
//
//            //double halfBeamWidth = fSettings->GetTistarSettings()->GetBeamWidth()/2.;
//            //if(TMath::Abs(vertex.X()) > halfBeamWidth || TMath::Abs(vertex.Y()) > halfBeamWidth) { // BEGIN-IF - FOR ORIGIN DEBUGGING
